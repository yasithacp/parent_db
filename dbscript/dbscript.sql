...
CREATE TABLE rc_student_parent_information (student_id BIGINT not null auto_increment, current_class VARCHAR(10) NOT NULL, student_surname VARCHAR(35) NOT NULL, student_other_names VARCHAR(50) NOT NULL, date_of_birth DATE NOT NULL, religion VARCHAR(20) NOT NULL, student_admission_no VARCHAR(10) NOT NULL, class_of_admission VARCHAR(10) NOT NULL, race VARCHAR(20) NOT NULL, date_of_admission DATE, house VARCHAR(20) NOT NULL, medium VARCHAR(10) NOT NULL, residential_address VARCHAR(255) NOT NULL, scholar_from_other TINYINT DEFAULT 0, scholar_from_royal TINYINT DEFAULT 0, no_scholar TINYINT DEFAULT 0, father_name VARCHAR(100) NOT NULL, father_occupation VARCHAR(50) NOT NULL, father_other_occupation VARCHAR(50), father_designation VARCHAR(50), father_company VARCHAR(50), is_father_old_boy TINYINT DEFAULT 0, father_ob_membership_id BIGINT, father_office_address VARCHAR(255), father_contact_number_mobile BIGINT, father_contact_number_office BIGINT, father_contact_number_residential BIGINT, father_email VARCHAR(100), mother_name VARCHAR(100) NOT NULL, mother_occupation VARCHAR(50) NOT NULL, mother_other_occupation VARCHAR(50), mother_designation VARCHAR(50), mother_company VARCHAR(20), mother_admission_number VARCHAR(20), present_address_office VARCHAR(255), mother_contact_mobile BIGINT, mother_contact_office BIGINT, mother_contact_residential BIGINT, mother_email VARCHAR(100), guardian_name VARCHAR(100), guardian_designation VARCHAR(20), guardian_relationship_to_student VARCHAR(20), guardian_address VARCHAR(255), guardian_office_address VARCHAR(255), guardian_contact_mobile BIGINT, guardian_contact_office BIGINT, guardian_contact_residential BIGINT, guardian_email VARCHAR(100), emergency_name VARCHAR(100) NOT NULL, emergency_relationship_to_student VARCHAR(20) NOT NULL, emergency_address VARCHAR(255) NOT NULL, emergency_contact_mobile BIGINT NOT NULL, emergency_contact_office BIGINT, emergency_contact_residential BIGINT NOT NULL, PRIMARY KEY(student_id)) ENGINE = INNODB;